...
echo "4) 네임스페이스 생성 (product-service-dev / staging / prod, argo-rollouts)"
...
echo "  RBAC 실습용 계정도 함께 만들어졌습니다: dev1 / dev12345!, release-mgr / release12345!"
echo "연결 상태를 확인하려면: bash verify.sh"
echo "이어서 ArgoCD를 설치하려면: bash argocd/install-argocd.sh"
